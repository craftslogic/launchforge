  ...
  return (
    <section ref={containerRef} className="py-40 relative bg-background overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <motion.div 
          style={{ scale, rotate }}
          className="relative w-full aspect-[16/9] md:aspect-[21/9] rounded-[2rem] md:rounded-[3rem] border border-white/10 bg-white/[0.02] backdrop-blur-xl overflow-hidden shadow-2xl flex items-center justify-center p-8 md:p-16"
        >
          {/* Internal composition representing Brand Identity */}
          <div className="w-full h-full relative grid grid-cols-3 grid-rows-2 gap-4 md:gap-8">
            {/* Logo area */}
            <div className="col-span-1 row-span-2 rounded-2xl md:rounded-3xl bg-gradient-to-br from-white/5 to-transparent border border-white/10 flex flex-col items-center justify-center relative overflow-hidden group">
            ...
            {/* Typography */}
            <div className="col-span-2 row-span-1 rounded-2xl md:rounded-3xl bg-white/5 border border-white/10 p-6 md:p-8 relative overflow-hidden group">
               <div className="absolute top-0 right-0 p-6">
                  <Type className="w-6 h-6 text-white/20 group-hover:text-accent transition-colors" />
               </div>
            ...
            {/* Color Palette */}
            <div className="col-span-1 row-span-1 rounded-2xl md:rounded-3xl flex gap-2 md:gap-4">
            ...
            {/* UI Elements */}
            <div className="col-span-1 row-span-1 rounded-2xl md:rounded-3xl bg-gradient-to-tl from-white/5 to-transparent border border-white/10 p-6 flex flex-col justify-between group">
              <Layout className="w-6 h-6 text-white/20 group-hover:text-primary transition-colors mb-4" />
              <div className="space-y-3">
                <div className="h-8 w-full rounded-lg bg-white/10" />
                <div className="h-8 w-2/3 rounded-lg bg-primary/80" />
              </div>
            </div>
          </div>
        </motion.div>
